...
} from "./core/storage.js?v=2026-05-26.1";

import { speakJP, warmupTTS } from "./core/tts.js?v=2026-05-26.1";
import { playCorrect, playWrong, unlockAudio } from "./core/audio.js?v=2026-05-26.1";

import {
  newQuestion, recordResult, startSession,
  normalizeRomaji, pct
} from "./core/quiz.js?v=2026-05-26.1";

import { t, getLang, setLang, applyI18nDOM } from "./core/i18n.js?v=2026-05-26.1";
...
async function init() {
  ...
  try {
    ...
    const [zhTW, ja, en] = await Promise.all([
      loadJSON("./data/meanings_zh_TW.json?v=2026-05-26.1").catch(() => ({})),
      loadJSON("./data/meanings_ja.json?v=2026-05-26.1").catch(() => ({})),
      loadJSON("./data/meanings_en.json?v=2026-05-26.1").catch(() => ({})),
    ]);
